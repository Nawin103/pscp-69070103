...
```text
Input:
รับค่าต้นทาง และ ปลายทางที่ต้องส่งและน้ำหนัก

Output:
พิมพ์ ราคาที่ต้องจ่าย

Constraints:
ถ้าไม่ต้องทางหรือปลายทางไม่มีในตารางให้พิมพ์ error
```
...
Step 2: คำนวณราคาที่ต้องจ่ายจากน้ำหนักตามในตาราง
Step 3: ถ้าจริง ให้พิมพ์ ราคาที่ต้องจ่าย
Step 4: ถ้าไม่มีในตาราง ให้พิมพ์ Error
```
...
```text
ใช้เพื่อตรวจในว่าต้นทางหรือปลายทางมีในตาตรางไหมและนำไปเที่ยบแล้วเอาคูณกับน้ำหนักและพิมพ์ออกมาเป็นราคา
แต่ถ้าไม่มีในตารางให้พิมพ์ error
```
...
```text
เพื่อดูว่าจะตรวจได้ไหมว่าไม่มีในตาราง
```
...
```text
เพื่อดูว่าถ้าเป็นทศนิยมจะerror ไหม
```
