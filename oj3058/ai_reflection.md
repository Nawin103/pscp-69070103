...
| OJ submission ID, if submitted | 632640 |
| OJ status | Pass |
...
```text
ไม่จำเป็นต้องใช้ loop ใช้คณิตหาเลยได้
```
...
```text
คำนวณสูตรหาจำนวนที่ต้องใช้ของอิฐ
```
...
```text
ได้เรียนรู้ว่าไม่จำเป็นต้องใช้ loop กับทุกอย่าง และได้รู้วิธี่ใช้ function min
```
