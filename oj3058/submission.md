...
```text
Input:
รับค่าของ จำนวนอิฐก้อนเล็กและก้อนใหญ่ และระยะทางที่ต้องการ

Output:
พิมพ์ จำนวนอิฐก้อนเล็กที่ต้องใช้

Constraints:
ถ้าใช้ก้อนอิฐทั้งหมดแล้วยังไม่ได้ระยะทางที่ต้องการต้องพิมพ์ -1
```
...
Step 2: หาว่าถ้าใช้อิฐก้องใหญ่แล้วจะเหลือให้ใช้อิฐก้อนเล็กเท่าไร
Step 3: ให้พิมพ์จำนวนอิฐก้อนเล็กที่ต้องใช้
Step 4: ถ้ถ้าใช้ทั้งหมดแล้วยังไม่ถึงระยะทางที่ต้องการให้พิมพ์ -1
```
...
```text
หาว่าถ้าใช้อิฐก้อนใหญ่แล้วจะเหลือให้ใช้อิฐก้อนเล็กเท่าไรถ้าถึงระยะทางที่ต้องการถึงจะพิมพ์จำนวนอิฐที่ต้องใช้ถ้าไม่ถึงให้พิมพ์ -1
```
...
```text
เทสว่าถ้าไม่พอจะprintออกมาถูกไหม
