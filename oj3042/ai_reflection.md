...
| OJ submission ID, if submitted | 564712 |
| OJ status | Pass |
...
```text
ช่วยแนะนำว่าถ้าจะ print ขอความในบันทัดเดียวต้องใช่คำสั่งอะไร
```
...
```text
ได้รู้ว่าถ้า printอยู่ใน loop จะ print ได้หลายค่า
```
