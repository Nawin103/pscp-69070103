...
Step 2: หารปัดเศษจำนวนนั้น
Step 3: ใช่ loop ลดที่ละ 10
Step 4: พิมพ์จำนวนนั้นและ loop ไปเรื่อยๆจนถึง 0
```
...
```text
ใช้ modulo ปัดเศษก่อนและให้จำนวนนั้นลดลงไปที่ละ 10จนถึง 0 และพิมพ์จำนวนทั้งหมดออกมา
```
...
```text
เพื่อดูว่าถ้าค่าเยอะมัน error ไหม
```
...
```text
เพื่อดูว่าถ้าไม่ถึง 10 มันจะมันจะบั๊กไหม
```
