...
```text
Input:
รับค่าจำนวนคน ระยะทางการส่ง และต่ำแหน่งของขโมย

Output:
พิมพ์จำนวนที่ต้องส่งจนกว่าจะเข้าเงื่อนไขที่ 1 หรือ 2

Constraints:
วนไปเรื่อยๆจนกว่าจะเข้าเงือนไข
```
...
```text
Step 1: อ่านinput
Step 2: นำไปเข้าใน while loop
Step 3: loop จนกว่าจะเข้าเงื่อนไข 1 หรือ 2
Step 4: เมื่อเข้าเงื่อนไขให้ พิมพ์ จำนวนที่ส่ง
```
...
```text
รับค่า input แล้วเข้า while loop แล้ว loop จนกว่าจะเข้าเงื่อนไขที่ 1 หรือ 2 แล็วจึงค่อยพิมพ์จำนวนที่ส่งที่นับไว้ตอนเข้า loop
```
...
```text
ถ้าเลขเดียวกันทั้งหมดจะ error ไหม
```
...
```text
ถ้าเลขของโจรน้อยกว่าที่นั่งที่มีจะะเป็นยังไง
```
