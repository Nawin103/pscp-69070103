...
```text
Input:
โปรแกรมรับจำนวนหยดหมึกและระยะการแพร่กระจาย

Output:
พิมพ์เวลาที่ บ้านของเขาจะถูกน้ำท่วมในวินาทีที่เท่าไรบ้าง

Constraints:
input ไม่แน่นอนต้องให้ loop
```
...
Step 2: ตรวจว่าหยดหมึกนี้จะขยายไปเท่าไหน
Step 3: เอาขนาดของหยดหมึกไปหารระยะแพร่กระจาย
Step 4: ให้พิมพ์ เวลาที่บ้านจะถูกท่วม
```
...
```text
หาพื้นที่ของหยดหมึดและนำไปหารกับระยะแพร่กระจายของหยดหมึกเพื่อให้ได้ระยะเวลาในการท่วม
```
...
```text
เช็คว่าจะ loop ครบจำนวนที่ให้ไปไหม
```
