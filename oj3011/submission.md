...
```text
โจทย์ให้นำสี1ไปผสมกันสีที่2และสร้างออกมาตามสีที่กำหนด

Input:
สีสองสีที่ต้องการผสมกัน 

Output:
สีที่ผสมออกมา

Constraints:
input เป็นสีที่มีแค่ 3 สี คือ สีแดง (Red) สีเหลือง (Yellow) และสีน้ำเงิน (Blue) 
```
...
```text
Step 1: อ่านสีและสีที่ไปผสม
Step 2: ตรวจว่า สีแรกคืออะไร และจะนำไปผสมกับสีอะไร
Step 3: print ตามสูตรผสมสี
Step 4: ถ้าไม่ตรงเลย ให้print Error
```
...
```text
วิธีสุดท้ายของฉันคือหาสีแรกก่อน และนำไปจับคู่กับสีที่ 2 print ตามสูตรผสมสี แต่ถ้าสีไม่มีในแม่สีให้ print "Error"
```
...
```text
ตรวจว่าถ้าใส่ input ที่ไม่ใช่แม่สีที่ให้มา มันจะprintได้ถูกต้อง
```
...
```text
ตรวจว่าถ้าใส่สีเดียวกันมันจะไม่ print error
```
...
```text
เพื่อตรวจสอบว่าprintถูกตามสูตรผสมสีที่ให้มาหรือไม่
```
