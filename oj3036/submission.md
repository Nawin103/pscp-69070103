...
```text
Input:
โปรแกรมรับค่าห้องที่เรานั้นอยู่

Output:
พิมพ์ จำนวนห้องที่เราต้องผ่านในการไปถึงห้องที่ 1

Constraints:
input เป็นแค่ห้องที่เราอยู่
```
...
```text
Step 1: อ่านห้องที่อยู่
Step 2: ตรวจหาแถวที่ห้องอยู่
Step 3: หาว่าแถวนั้นหาร 2 แล้วได้เศษ 1 หรือ 0
Step 4: พิมพ์ จำนวนห้องที่ต้องผ่าน
```
...
```text
หลังจากได้ input แล้วให้หาว่า ห้องนั้นอยู่ในแถวไหน หลังจากรู้แถวแล้วก็นำมาหารหารเศษว่าได้เศษ 1 หรือลงตัว แล้วนำไปเช็คใน if else ว่าห้องหารหาเศษได้ 1 หรือ ลงตัวและให้พิมพ์จำนวนห้องที่้องผ่านตามสูตร
```
...
```text
ดูว่าถ้าอยู่ห้อง 1 อยู่แล้วมันจะเป็นยังไง
```
