...
รับจำนวนเต็ม
2ค่า
ค่าแรกคือเดือน ค่าที่สองคือวัน

Output:
print season ที่ในเดือน และ วันนั้นควรจะเป็น

Constraints:
ถ้าในเดือนที่หารด้วย 3 ลงตัวและหลังจากวันที่ 21 จะเปลี่ยน season
```
...
```text
Step 1: อ่านค่าเดือน และ วันที่
Step 2: ตรวจว่าเดือนหารด้วย 3 ลงตัวและวันที่ไม่น้อยกว่า 21 ไหม
Step 3: ถ้าจริง ให้print season ตามเดือน
Step 4: ถ้าไม่จริง ให้เช็คว่าเดือนที่เท่าไร 3,6,9 หรือ 12
Step 5: ถ้าได้เดือนที่ 3 ให้ print spring
ถ้าได้เดือนที่ 6 ให้ print  summer
ถ้าได้เดือนที่ 9 ให้ print fall
ถ้าได้เดือนที่ 12 ให้ print winter
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกคือ หาค่าเดือนว่าเดือนที่เท่าไรก่อนและถ้าเป็นเดือนที่หาร 3 ลงตัวต้องวันไม่มากกว่า 21 ให้print ตาม season ที่กำหนดมาแต่ถ้าเดือนที่หาร 3 ลงตัวและวันที่มากกว่า 21 ต้องเปลี่ยนเดือนตามที่กำหนด
```
...
```text
ตรวงว่าถ้าวันที่ 21 มันจะเปลี่ยน season ไหม
```
...
```text
ตรวจดูว่าถ้าไม่ใช้วันที่ 21 จะยังเปลี่ยน season ไหม
```
...
```text
ตรวจดูว่าถ้าวันที่น้องกว่า 21 season จะไม่เปลี่ยนใช่ไหม
```
