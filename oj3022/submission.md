...
Input:
รับจำนวนค่าอุณหภูมิ และบรรทัดที่ 2 ระบุหน่วยวัดของค่าที่ให้มา และ บรรทัดที่ 3 คือหน่วยวัดที่ต้องการจะเปลี่ยนไป

Output:
พิมพ์ค่าอุณหภูมิที่แปลงมา

Constraints:
มี่สูตรแค่เปลี่โดยใช้หน่วยวัด c  ทำให้ถ้าได้รับค่าแรกมาไม่ใช่หน่วย c ก็ต้องไปเปลี่ยนเป็น c ก่อนจึงจะแปลงค่าได้
```
...
```text
Step 1: อ่านหน่วยวัดที่ได้มาในค่าแรก
Step 2: แปลงอุณหภูมิให้เป็น c
Step 3: แปรงเป็นหน่วยวัดที่สองที่โจทย์ต้องการ
Step 4: พิมพ์ ค่าที่แปลงมาได้
```
...
```text
ตรวจหาก่อนว่าที่ได้รับมาเป็นหนว่ยวัดอะไรและแปลงเป็นหน่วยวัด c แล้วค่อยแปลงให้กลายเป็นหน่วยวัดที่ โจทย์ต้องการ
```
...
```text
เทสว่าถ้าไม่ได้หน่วยวัด c มาจะแปลงค่าถูกไหม
```
...
```text
ดูว่าถ้าใส่จำนวนทศนิยมจะเกิ error ไหม
```
