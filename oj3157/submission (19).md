...
Output:
พิมพ์ คะแนนหลังรับคำสั่งทั้งหมด

Constraints:
ให้ input มาแค่จำนวนคำสั่ง
```
...
```text
Step 1: อ่านจำนวนคำสั่ง
Step 2: เข้าloop คำนวณคะแนน
Step 3: พิมพ์ คะแนนหลังจากคำนวณเสร็จ
...
```text
เมื่อรับค่าจำนวนคำสั่งแล้วนำเข้า loop และนำไปคำนวณคะแนนต่างเครื่องหมายที่ให้มาแล้วเมื่อหลังจากคำนวนเสร็จแล้วพิมพ์ค่าที่ได้ออกมา
```
...
```text
ลองแบบปกติเพื่อเช็คว่าcode ใช้งานได้ไหม
```
...
```text
ถ้าเครื่องหมายเป็นบวกหมดจะใช้ได้ไหม
```
...
```text
ถ้าเครื่องหมายเป็นลบทั้งหมดจะใช้ได้ไหม
```
