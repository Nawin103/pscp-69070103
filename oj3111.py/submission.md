...
```text
Input:
รับค่าสมาชิกและจำนวนของที่ซื้อ
Output:
พิมพ์ราคาที่ลดแล้ว

Constraints:
จะลดก็ต่อเมื่อเป็นสมาชิกหรือถ้าไม่ได้เป็นสมาชิกต้องซื้อเกิน 500 ถึงจะลด
```
...
```text
Step 1: อ่านจำนวนของที่ซื้อและเป็นสมาชิกไหม
Step 2: ถ้าเป็นสมาชิกให้เอาราคาทั้งหมดลดไป 5 percent
Step 3: ถ้าไม่เป็นสมาชิกให้ตรวจว่าเกิน500ไหมเกิน ให้ลดไป 3 percent ถ้าไม่เกิน 500 ไม่ต้องลด
Step 4: พิมพ์ราคาที่ลดแล้ว
```
...
```text
ตรวจก่อนว่าเป็นสมาชิกไหมถ้าเป็นให้ลด ถ percent ถ้าไมเป็นให้เช็คก่อนว่า ราคาทั้งหมดเกิน 500 ไหมถ้าเกินให้ลด 3 percent ถ้าไม่ให้พิมพ์ราคาเดิม
```
...
```text
ตรวจว่าถ้าเป็นสมาชิกจะลดได้ไหม
```
...
```text
ถตรวจว่าถ้าไม่เป็นสมาชิกและเกิน 500 จะลดถูกต้องไหม
```
...
```text
ตรวจว่าถ้าไม่เกิน500และไม่เป็นสมาชิกมันจะลดไหม
```
