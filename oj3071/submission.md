...
```text
Input:
รับค่าตั้งแต่ช่วง a ถึง b และได้ค่าตัวที่นำไปหารและ เศษที่ต้องการ

Output:
จำนวนตัวเลขที่หารตัวที่โจทย์กำหนดแล้วได้เศษที่โจทย์กำหนด

Constraints:
input เป็นจำนวนช่วง ฉันจึงหาวิธีใช้ช่วงที่ให้มา
```
...
```text
Step 1: อ่านจำนวนช่วง
Step 2: loop หารตัวที่โจทย์ให้และเอาเศษมาเทียบกับที่โจทย์กำหนดให้
Step 3: ถ้าจริง ให้จำนวนเพิ่ม 1 ใน count
Step 4: loop เสร็จให้พิมพ์ count
```
...
```text
นำตัวหารไปหารตัวเลขทั้งหมดในช่วงที่โจทย์กำหนดให้และนำมาเทียบกับเศษที่โจทย์ให้ และนับจำนวนที่หารแล้วได้เศษตามที่โจทย์กำหนดมา สุดท้ายพิมพ์ จำนวนทั้งหมด
```
...
```text
เพื่อตรวจว่าช่วงน้อยจะทำงานไหม
```
