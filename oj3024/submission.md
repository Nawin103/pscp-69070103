...
```text
Input:
โปรแกรมรับจำนวนทั้งหมด และ จำนวนที่สูงสุดในค่านั้น

Output:
ถ้า ค่าสูงสุดห่างกันเกิน 2 ให้พิมพ์ Surprising แต่ถ้าไม่ให้พิมพ์ Not surprising
```
...
Step 2: ตรวจว่า ค่าสูงสุดห่างจากค่าต่ำสุดเกิน 2 ไหม
Step 3: ถ้าใช่ให้พิมพ์ "Even"
Step 4: ถ้าไม่ใช่ ให้พิมพ์ "Not surprising"
```
...
```text
นำจำนวนทั้งหมดไปลบกับจำนวนสูงสุด และ หาจำนวนที่ต่ำที่สุด และนำจำนวนที่สูงที่สุดไปลดกับจำนวนที่ต่ำที่สุดและดูว่ามันได้เกิน 2 ไหมถ้าใช่ให้พิมพ์ Surprising ถ้าไม่ให้พิมพ์ not surprising
```
...
```text
หาว่าถ้าค่ามันเท่ากันจะได้อะไร
```
...
```text
เพื่อตรวจว่าถ้าค่าน้อยจะได้ไหม
```
...
```text
เพื่อตรวจว่าถ้าค่าไม่ถึงสองหลักจะได้ไหม
```
