...
| OJ submission ID, if submitted | 576392 |
| OJ status | Pass |
...
```text
มี่วิธีกำหนดค่าไม่ให้ต่ำกว่า 0 ไหม
```
...
```text
ให้ใช้ max ในการเปรีบยเทียบค่า
```
...
```text
ฉันได้เรียนรู้วิธีใช้ฟังก์ชั่น max และการทำงานของ max
```
