...
```text
Input:
รับค่าเป็น String ภาษาอังกฤษ 5  ตัวอักษร

Output:
ข้อความตัวอักษรภาษาอังกฤษแบบกลับด้าน
...
```text
Step 1: อ่าน string
Step 2: ทำให้ string กลายเป็นตัวพิมพ์เล็ก
Step 3: กลับด้าน string ที่แปลงเป็นตัวเล็กแล้ว
Step 4: print string ที่กลับด้านแล้ว
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แปลง string ให้เป็นตัวเล็กก่อน แล้วค่อยกลับด้านตัวอักษร
```
...
```text
เพื่อตรวจสอบว่ามันถูกแปลงเป็นตัวพิมพ์เล็กทั้งหมดจริงๆ
```
...
```text
เพื่อตรวจสอบว่าถ้ามีเครื่องหมายก็ยังใช้ได้
```
...
```text
เพื่อตรวจสอบว่าถ้ามีตัวเลขก็สามารถใช้ได้
```
