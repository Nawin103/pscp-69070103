...
| OJ submission ID, if submitted | 641241 |
| OJ status | Pass |
...
```text
ช่วยคิดว่าควรคำนวนหาจำนวนเฉพาะยังไงดี
```
...
```text
ให้สูตรว่าควรคำนวนหาจำนวนเฉพาะยังไง
```
...
```text
เอาสูตรที่ ai ให้มาแปลงเป็น code
```
