...
```text
Input:
รับค่าเลขเริ่มและเลขสุดท้าย

Output:
พิมพ์จำนวนเฉพาะทุกเลขและจำนวนทั้งหมด

Constraints:
ให้inputเป็นช่วงต้องหาวิธีใช้ input
```
...
```text
Step 1: เมื่อรับช่วงมาแล้วนำไปเข้า loop
Step 2: ตรวจว่า  มากกว่า 1 ไหม
Step 3: คำนวนจำนวนเฉพาะ
Step 4: พิมพ์จำนวนเฉาะทุกจำนวนในช่วง และ จำนวนของจำนวนเฉพาะทั้งหมด
```
...
```text
เอาช่วงที่ได้เข้า loop และคำนวณหาจำนวนเฉพาะแล้วพิมพ์ออกมา
```
...
```text
ลองแบบไม่เยอะก่อนจะได้รู้ว่าถูกไหม
```
