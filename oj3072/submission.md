...
Output:
พิมพ์ตัวอักษรที่นับมาได้และแยกแต่ละตัวอักษร

Constraints:
input เป็นจำนวนคำ ต้องหาวิธีเช็คแต่ละตัวอักษรในคำนั้น
```
...
Step 2: นับจำนวนแต่ละตัวอักษรในคำ
Step 3: มาเช็คค่าว่าอันไหมไม่มีกับอันไหนมีในคำบ้าง
Step 4: ถ้าให้พิมพ์ ตัวอักษรที่มีการนับมากกว่า 0
```
...
```text
ตรวจว่าอักษรไหนมีในคำบ้างและพิมพ์ตัวอักษรที่มีการนับมากกว่า 0 ทั้งหมด
```
...
```text
ตรวจว่าถ้ามีทุกตัวอักษรจะพิมพ์ถูกไหม
```
...
```text
ถ้ามีตัวอักษรเดียวจะพิมพ์ได้ไหม
```
...
```text
ตรวจว่าถ้าไม่มีตัวสระละจะพิมพ์ออกมาไหม
```
