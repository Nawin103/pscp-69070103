...
| OJ submission ID, if submitted | 576725 |
| OJ status | Pass |
...
```text
ถ้าอยากตรวจตัวอักษรในคำต้องใช้ function อะไร
```
...
```text
ลองเขียนcode ไปให้ ai ดู แต่ ai แนะให้ไปใช้ อันอื่น
```
...
```text
เปลี่ยนจากเช็คค่าทุกตัวอักษรในที่เดียว เป็นแยกที่ละอักษร
```
...
```text
ได้เรียนรู้วิธีใช้function sum และได้รู้ว่าเราสามารถเขียน loop ในบรรทัดเดียวได้
```
